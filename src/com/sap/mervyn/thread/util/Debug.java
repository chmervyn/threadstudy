...
public class Debug {
    ...
    public static void info(boolean message) { info("%s", message); }

    public static void info(int message) { info("%d", message); }

    public static void error(String message, Object... args) { printf(Label.ERR, message, args); }
